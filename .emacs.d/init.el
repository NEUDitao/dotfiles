...
(setq initial-scratch-message
      (concat ";; If pretty little blue birds fly\n"
	      ";; beyond the rainbow\n"
	      ";; Why oh why can't I?"))

;; no more tool bars and scroll bars
(toggle-scroll-bar -1)
(tool-bar-mode -1)

;; if it's graphic (i'm not using shell emacs normally but... extensible)
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (web-mode markdown-mode use-package rainbow-delimiters racket-mode flycheck))))
(custom-set-faces
